                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Usúario">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-center links">
                            Não tem conta?<a href="https://localhost/site/cadastre-se">Cadastre-se</a>
                        </div>
                        <div class="d-flex justify-content-center">
                        
                        <a href="https://localhost/site/esqueci-minha-senha"  data-bs-toggle="modal" data-bs-target="#esqueci-minha-senha">Esqueceu sua senha?</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade " id="esqueci-minha-senha" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    ...
    <form action="" class="box1">
            <fieldset>
                ...
                <div class="inputBox">
                    <input type="text" name="email" id="email" class="inputUser" required>
                    <label for="email" class="labelInput">Confime E-mail</label>
                </div>
                <br><br>
